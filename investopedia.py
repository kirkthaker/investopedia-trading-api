# A series of functions for executing trades on Investopedia's Stock simulator
# Makes use of Python's mechanize library
import mechanize

def login(username, password):
    # This function logs a user into Investopedia's trading simulator
...
def trade(handle, symbol, orderType, quantity, priceType="Market", price=False, duration=2):
